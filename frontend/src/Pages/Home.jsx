...
import FeaturedNotesSection from "./FeaturedNotesSection";
                ...
                <div className="mx-auto flex flex-col items-center py-12 sm:py-24">
                    <div className="w-11/12 sm:w-2/3 lg:flex justify-center items-center flex-col mb-5 sm:mb-10">
                        <h1 className="text-4xl sm:text-5xl md:text-5xl lg:text-5xl xl:text-6xl text-center text-gray-800 dark:text-white font-black leading-10">
                            Let's make learning easier with{" "}
                            <span className="text-violet-800 dark:text-violet-500">Note Sharing</span>.
                        </h1>
                        <p className="mt-5 sm:mt-10 lg:w-10/12 text-gray-600 dark:text-gray-300 font-normal text-center text-xl">
                            A community-driven platform to share, access, and collaborate on educational notes.
                        </p>
                    </div>
